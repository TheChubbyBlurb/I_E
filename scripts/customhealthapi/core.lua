...
local root = "scripts.customhealthapi" -- Replace with the location of the 'customhealthapi' folder in your mod (e.g. "modscripts.dependencies.customhealthapi.")
local modname = "Custom Health API (Isaac's Ecstasy)" -- Replace with "Custom Health API" + the name of your mod (e.g. "Custom Health API (My Cool Isaac Mod)"
local modinitials = "IE" -- Replace with the initials of your mod (e.g. "MCIM")
